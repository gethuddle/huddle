...
export const DOMAIN_ERROR_MESSAGES = {
  ...
  VENUE_SUBSCRIPTION_REQUIRED: "Activate this venue subscription to continue.",
  VENUE_BILLING_OWNER_REQUIRED: "Only the venue owner can manage billing.",
  VENUE_BILLING_PENDING: "This venue already has a subscription or checkout in progress.",
  VENUE_BILLING_UNAVAILABLE: "Venue billing is temporarily unavailable. Try again later.",
  VENUE_DEFAULTS_INCOMPLETE: "Add an active viewing area with a capacity before planning.",
  VENUE_SPACE_OVERLAP: "That viewing area already has an event during this time.",
  MATCH_ALREADY_PLANNED: "That fixture is already planned for this venue.",
