...
| Product capabilities/processes | App routes and feature modules; implementation spec §§1–4 | 32 Playwright scenarios, including contract journeys 01–17; core demo | 32/32 local scenarios pass |
...
| Database/entities | 37 ordered migrations and generated `Database` type | reset, 41 pgTAP files / 1685 assertions, type-drift gate | Ready locally |
