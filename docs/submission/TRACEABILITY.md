...
| Database/entities | 30 ordered migrations and generated `Database` type | reset, 36 pgTAP files / 1624 assertions, type-drift gate | Ready locally |
...
| Test specification/code | submission test plan and repository suites | 757 Vitest tests; 1624 pgTAP assertions; 28 Playwright scenarios; `npm run test:acceptance` | Ready locally; reciprocal review remains required before merge |
