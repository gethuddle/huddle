...
| Database/entities | 14 ordered migrations and generated `Database` type | reset, 19 pgTAP files, type-drift gate | Ready locally |
...
| Test specification/code | submission test plan and repository suites | 412 Vitest tests; 990 pgTAP assertions; 17 Playwright journeys; `npm run test:acceptance` | Ready locally; reciprocal PR #35 re-review pending |
