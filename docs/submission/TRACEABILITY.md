...
| Database/entities | 34 ordered migrations and generated `Database` type | reset, 40 pgTAP files / 1642 assertions, type-drift gate | Ready locally |
...
| Test specification/code | submission test plan and repository suites | 765 Vitest tests; 1642 pgTAP assertions; 28 Playwright scenarios; `npm run test:acceptance` | Ready locally; reciprocal review remains required before merge |
...
| Public deployment | [candidate Vercel URL](https://huddle-navy-five.vercel.app), production/preview env validation, and deployment runbook | production session/full smoke | Candidate baseline reachable; B13 hosted acceptance pending |
