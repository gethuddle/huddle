...
| Database/entities | 33 ordered migrations and generated `Database` type | reset, 39 pgTAP files / 1656 assertions, type-drift gate | Ready locally |
...
| Test specification/code | submission test plan and repository suites | 778 Vitest tests; 1656 pgTAP assertions; 28 Playwright scenarios; `npm run test:acceptance` | Ready locally; reciprocal review remains required before merge |
