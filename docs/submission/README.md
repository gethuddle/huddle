...
| Product specification | [`HUDDLE-ARCHITECTURE.md`](../HUDDLE-ARCHITECTURE.md) §§1–3 and [`HUDDLE-IMPLEMENTATION-SPEC.md`](../HUDDLE-IMPLEMENTATION-SPEC.md) §§1–4 | Baseline and VB01 local acceptance complete; hosted evidence pending |
...
| Test plan and test code | [`TEST-PLAN.md`](./TEST-PLAN.md), `*.test.ts(x)`, `supabase/tests/database/`, and `tests/e2e/` | VB01 local acceptance passed; PR/main CI and hosted evidence pending |
| Basic scale document | [`SCALABILITY.md`](./SCALABILITY.md) | Pre-deployment snapshot recorded; B13 hosted usage pending |
| Basic security document | [`SECURITY.md`](./SECURITY.md), [`B11-SECURITY-CHECKLIST.md`](../B11-SECURITY-CHECKLIST.md), and [`POLAR-SANDBOX-BILLING.md`](../operations/POLAR-SANDBOX-BILLING.md) | Local controls accepted; VB01 hosted inspection/Task 11 pending |
