...
The accepted B12 local run passed 403 Vitest/unit/component tests, 975 pgTAP assertions, the generated-type check, the production build, and all 17 Playwright journeys. Current post-B12 acceptance evidence is maintained under [`docs/evidence/`](./docs/evidence/). Local hand-in materials and rehearsal notes are intentionally excluded from the public repository.
