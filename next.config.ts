...
const buildEnvironment = parseServerEnvironment({
  ...
  POLAR_VENUE_MONTHLY_PRODUCT_ID: process.env.POLAR_VENUE_MONTHLY_PRODUCT_ID,
  POLAR_VENUE_YEARLY_PRODUCT_ID: process.env.POLAR_VENUE_YEARLY_PRODUCT_ID,
  HUDDLE_AUTOMATION_BLOCK_POLAR_NETWORK: process.env.HUDDLE_AUTOMATION_BLOCK_POLAR_NETWORK,
