...
where venue_id in ('e4000000-0000-4000-8000-000000000602');
...
select throws_ok(
  $$
    select public.follow_venue('e4000000-0000-4000-8000-000000000602',null)
  $$,
  'P0001', 'AUTH_REQUIRED',
  'the serialized Venue-follow RPC rejects a tombstoned actor'
);
