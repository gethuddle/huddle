-- Representative city centers were reviewed against the GeoNames Israel dump
-- (https://download.geonames.org/export/dump/IL.zip) on 2026-08-25. They are
-- discovery fallbacks, not municipal-boundary or address coordinates.
...
do $seed$
begin
  raise notice 'Huddle B02 seed complete: 13 reviewed city fallbacks are available.';
end;
$seed$;
